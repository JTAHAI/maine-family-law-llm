...
- It stores local app state under `%LOCALAPPDATA%\MaineFamilyLawLLM`.
- It does not bundle private matter data, authority corpora, embeddings, OCR caches, uploads, logs, or model weights.
- It is not legal advice and is not affiliated with the Maine Judicial Branch or any court.
