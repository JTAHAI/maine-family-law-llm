...
- Local matter opening, record import, inventory, deterministic parsing, and duplicate/change review.
- Offline OCR searchable derivatives that preserve originals.
- Local document privacy analysis and review-safe redaction workflow.
- Source-backed Maine family-law research against an admitted external official-authority build.
- Exact source spans, source hashes, citation/quote checks, and visible currentness warnings.
- Review-required drafting, revision comparison, evidence packets, and a fail-closed filing gate.
- Local-only controls, privacy boundaries, backup, and restore.
- Keyboard, focus, contrast, reduced-motion, responsive-layout, and error-state hardening.
