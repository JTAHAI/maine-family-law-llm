...
def summary(request: Request, x_user_role: str | None = Header(default=None, alias="X-User-Role")):
    ...
    return _invoke(_store().summary, action="productivity_summary", endpoint="GET /api/productivity")
...
def configure_inbox(payload: dict[str, Any], request: Request, x_user_role: str | None = Header(default=None, alias="X-User-Role")):
    _guard(request, x_user_role)
    return _invoke(_store().configure_inbox, payload, action="productivity_inbox_configure", endpoint="POST /api/productivity/inbox/configurations")
...
def scan_inbox(inbox_id: str, payload: dict[str, Any], request: Request, x_user_role: str | None = Header(default=None, alias="X-User-Role")):
    _guard(request, x_user_role)
    return _invoke(_store().scan_inbox, inbox_id, payload, action="productivity_inbox_scan", endpoint="POST /api/productivity/inbox/{inbox_id}/scan")
...
def save_recipe(payload: dict[str, Any], request: Request, x_user_role: str | None = Header(default=None, alias="X-User-Role")):
    _guard(request, x_user_role)
    return _invoke(_store().save_recipe, payload, action="productivity_recipe_save", endpoint="POST /api/productivity/recipes")
...
def run_recipe(recipe_id: str, payload: dict[str, Any], request: Request, x_user_role: str | None = Header(default=None, alias="X-User-Role")):
    _guard(request, x_user_role)
    return _invoke(_store().run_recipe, recipe_id, payload, action="productivity_recipe_run", endpoint="POST /api/productivity/recipes/{recipe_id}/run")
...
def export_calendar(payload: dict[str, Any], request: Request, x_user_role: str | None = Header(default=None, alias="X-User-Role")):
    _guard(request, x_user_role)
    return _invoke(_store().export_calendar, payload, action="productivity_calendar_export", endpoint="POST /api/productivity/calendar/exports")
...
def optimize_hardware(payload: dict[str, Any], request: Request, x_user_role: str | None = Header(default=None, alias="X-User-Role")):
    _guard(request, x_user_role)
    return _invoke(_store().optimize_hardware, payload, action="productivity_hardware_optimize", endpoint="POST /api/productivity/hardware/optimize")
...
def add_pinboard_item(payload: dict[str, Any], request: Request, x_user_role: str | None = Header(default=None, alias="X-User-Role")):
    _guard(request, x_user_role)
    return _invoke(_store().add_pinboard_item, payload, action="productivity_pinboard_add", endpoint="POST /api/productivity/pinboard/items")
...
def create_redaction_project(payload: dict[str, Any], request: Request, x_user_role: str | None = Header(default=None, alias="X-User-Role")):
    _guard(request, x_user_role)
    return _invoke(_store().create_redaction_project, payload, action="productivity_redaction_project", endpoint="POST /api/productivity/redaction/projects")
...
def finalize_redaction_project(project_id: str, payload: dict[str, Any], request: Request, x_user_role: str | None = Header(default=None, alias="X-User-Role")):
    _guard(request, x_user_role)
    return _invoke(_store().finalize_redaction_project, project_id, payload, action="productivity_redaction_finalize", endpoint="POST /api/productivity/redaction/projects/{project_id}/finalize")
...
def refresh_next_actions(payload: dict[str, Any], request: Request, x_user_role: str | None = Header(default=None, alias="X-User-Role")):
    _guard(request, x_user_role)
    return _invoke(_store().refresh_next_actions, payload, action="productivity_next_actions", endpoint="POST /api/productivity/next-actions/refresh")
...
def create_courtroom_session(payload: dict[str, Any], request: Request, x_user_role: str | None = Header(default=None, alias="X-User-Role")):
    _guard(request, x_user_role)
    return _invoke(_store().create_courtroom_session, payload, action="productivity_courtroom_session", endpoint="POST /api/productivity/courtroom/sessions")
...
def save_backup_schedule(payload: dict[str, Any], request: Request, x_user_role: str | None = Header(default=None, alias="X-User-Role")):
    _guard(request, x_user_role)
    return _invoke(_store().save_backup_schedule, payload, action="productivity_backup_schedule", endpoint="POST /api/productivity/backups/schedules")
...
def verify_backup(backup_id: str, request: Request, x_user_role: str | None = Header(default=None, alias="X-User-Role")):
    _guard(request, x_user_role)
    return _invoke(_store().verify_backup, backup_id, action="productivity_backup_verify", endpoint="GET /api/productivity/backups/{backup_id}/verify")
...
def restore_backup(backup_id: str, payload: dict[str, Any], request: Request, x_user_role: str | None = Header(default=None, alias="X-User-Role")):
    _guard(request, x_user_role)
    return _invoke(_store().restore_backup, backup_id, payload, action="productivity_backup_restore", endpoint="POST /api/productivity/backups/{backup_id}/restore")
...
def source_item(item_id: str, request: Request, x_user_role: str | None = Header(default=None, alias="X-User-Role")):
    _guard(request, x_user_role)
    return _invoke(_store().source_item, item_id, action="productivity_source_inspect", endpoint="GET /api/productivity/sources/{item_id}")
