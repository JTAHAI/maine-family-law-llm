...
if FastAPI is not None:
    ...
    def _runtime_diagnostics_payload() -> dict[str, Any]:
        return {
            "status": "ok",
            "version": __version__,
            "ui_version": "1.87.0-chat-library-routing-input-clear",
            ...
            "chat_library_language_v190": True,
            "operator_command_compatibility_v190": True,
            "enterprise_llm_chat_plan_v189": "docs/enterprise-llm-chat-ga-plan-v189.md",
            "chat_language_v190_report": "docs/chat-language-coverage-local-commands-pass-v190.md",
